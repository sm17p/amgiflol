<script lang="ts">
  ...
  const disableForFirefox =
    false && !import.meta.env.DEV && import.meta.env.FIREFOX;
</script>
  ...
  <Menu.Positioner>
    <Menu.Content class="bg-white p-1 rounded-lg shadow-lg outline-none">
      <div transition:fly={{ y: -10, duration: 200 }}>
        ...
        >
          <Menu.ItemGroupLabel>
            <h4 class="m-0 ml-1 grid grid-cols-[24px_1fr]">
              ...
              >
                <Switch
                  bind:checked={uiStore.toolbar.featureVotingVisible}
          ...
          {#if uiStore.toolbar.featureVotingVisible}
            <Menu.Separator class="-ml-1 -mr-1 block h-px bg-zinc-200" />
            <Menu.Item
        ...
        <Menu.Separator class="my-1 -ml-1 -mr-1 block h-px bg-zinc-200" />
        <Menu.ItemGroup
          class="grid grid-cols-1 gap-y-1"
        ...
        >
          ...
          <Menu.CheckboxItem
            ...
            closeOnSelect={false}
          >
            <Tooltip label="Disabled on lock" side="left" sideOffset={12}>
              <CircleQuestionMark class="size-4" />
            </Tooltip>
            <span class="min-w-[250px] flex justify-between items-center gap-3">
              <Switch
                checked={uiStore.sidePanel.autoMove}
                labelText="Auto-Move"
              />
            </span>
          </Menu.CheckboxItem>
        ...
        >
          ...
          >
            ...
            <span class="min-w-[250px] flex justify-between items-center gap-3">
              <Switch
                checked={uiStore.toolbar.autoMove}
                labelText="Auto-Move"
              />
            </span>
          </Menu.CheckboxItem>
          ...
          >
            ...
            <span class="min-w-[250px] flex justify-between items-center gap-3">
              <Switch
                checked={uiStore.toolbar.autoHide}
                labelText="Auto-Hide"
              />
            </span>
          </Menu.CheckboxItem>
